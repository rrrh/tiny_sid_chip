...
// 18-bit accumulator, 16-bit frequency register:
...
module tt_um_sid_tb;
    ...
    // 18-bit acc: freq_reg = Hz * 2^18 / (5e6/3) ≈ Hz * 0.1573
    localparam [15:0] FREQ_C4 = 16'd41,    // 262 Hz
                      FREQ_E4 = 16'd52,    // 330 Hz
                      FREQ_G4 = 16'd62,    // 392 Hz
                      FREQ_C5 = 16'd82;    // 523 Hz
